...
public class AnalizeTest {
    ...
    @Test
    public void whenAllNewAdded() {
        User u1 = new User(1, "A");
        User u2 = new User(2, "B");
        User u3 = new User(3, "C");
        Set<User> previous = Set.of(u1, u2, u3);
        Set<User> current = Set.of(new User(4, "D"), new User(5, "E"), new User(6, "F"));
        assertThat(
                Analize.diff(previous, current),
                is(new Info(3, 0, 3))
        );
    ...
    @Test
    public void when2Added1Changed1Deleted() {
        User u1 = new User(1, "A");
        User u2 = new User(2, "B");
        User u3 = new User(3, "C");
        Set<User> previous = Set.of(u1, u2, u3);
        Set<User> current = Set.of(u1, new User(2, "BB"), new User(4, "D"), new User(5, "E"));
        assertThat(
                Analize.diff(previous, current),
                is(new Info(2, 1, 1))
        );
