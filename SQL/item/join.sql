...
select * from employees e left join departments d on e.department_id = d.id;
select * from employees e right join departments d on e.department_id = d.id where department_id is not null;

select * from departments d left join employees e on e.department_id = d.id where department_id is not null;
